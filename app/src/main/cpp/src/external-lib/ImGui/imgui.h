...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_AutoCollapsed          = 1 << 19,
...
struct ImGuiIO
{
    ...
    IMGUI_API void  SetMousePosOff(float x, float y);                     // Queue a mouse position update. Use -FLT_MAX,-FLT_MAX to signify no mouse (e.g. app not focused and not hovered)
